...
{
    //This is the most simplest Singleton pattern. 
    //The problem is that it's not thread safe. 
    //If you want a thread safe Singleton, then visit the link: https://csharpindepth.com/articles/singleton
