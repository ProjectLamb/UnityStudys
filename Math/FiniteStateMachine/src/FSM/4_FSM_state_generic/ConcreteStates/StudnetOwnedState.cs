...
namespace FSM4_state_generic.StudnetOwnedState {
#region RestAndSleep
    public class RestAndSleep : State<Student> {
        public void Enter(Student entity) {
            entity.CurrentLocation = LOCATIONS.SWEET_HOME;
            entity.Stress = 0;
        ...
        public void Execute(Student entity) {
            ...
            if(entity.Fatigue > 0 ){
                ...
                entity.ChangeState(STUDENT_STATES.STUDY_HARD);
            }
        }
        ...
        public void Execute(Student entity){
            ...
            if(3 <= entity.Knowledge && entity.Knowledge <= 10) {
                ...
                if(isExit == 1 || entity.Knowledge >= 10) {
                    entity.ChangeState(STUDENT_STATES.TAKE_A_EXAM);
                }
            }

            if(20 <= entity.Stress) {
                entity.ChangeState(STUDENT_STATES.PLAY_A_GAME);
            }
            if(50 <= entity.Fatigue) {
                entity.ChangeState(STUDENT_STATES.REST_AND_SLEEP);
            }
...
#region TakeAEaxm
    public class TakeAExam : State<Student>{
        ...
        public void Enter(Student entity){
            entity.CurrentLocation = LOCATIONS.LECTURE_ROOM;
        ...
        public void Execute(Student entity){
            ...
            if(examScore <= 3) {
                entity.Stress += 20;
                entity.ChangeState(STUDENT_STATES.HIT_THE_BOTTLE);
            }
            else if (examScore <= 7) {
                entity.ChangeState(STUDENT_STATES.STUDY_HARD);
            }
...
#region PlayAGame
    public class PlayAGame : State<Student>{
        ...
        public void Enter(Student entity){
            entity.CurrentLocation = LOCATIONS.PC_ROOM;
